    ...
    <div className='font-SpaceGrotesk bg-[#242424] text-white w-full flex flex-col gap-6 pt-16 px-4 md:px-6 relative md:justify-center md:items-center lg:px-20' >
        ...
        <div className=' lg:flex lg:justify-between lg:items-start lg:w-full lg:gap-28'>
            ...
            <form ref={form} onSubmit={sendEmail} className=' flex flex-col gap-4 border-b-[1px] border-solid border-white pb-16 md:w-[400px] md:border-none '>
                <input className=' bg-[#242424] text-xs md:text-sm border-b-[1px] border-solid px-5 pb-4 pt-2  border-white outline-none' type="text " placeholder='NAME' name="user_name"/>
                <input className=' bg-[#242424] text-xs md:text-sm border-b-[1px] border-solid px-5 pb-4 pt-2 border-white outline-none' type="email" placeholder='EMAIL' name="user_email" required />
                <textarea className=' bg-[#242424] bg-transparent text-xs md:text-sm border-b-[1px] border-solid px-5 pt-2 border-white outline-none' placeholder='MESSAGE' cols="30" rows="5" name="message"></textarea>
